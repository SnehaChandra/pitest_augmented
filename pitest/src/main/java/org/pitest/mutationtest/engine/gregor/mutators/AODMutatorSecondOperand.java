...
public class AODMutatorSecondOperand implements MethodMutatorFactory {
  ...
  private final class NegateVariableVisitor extends MethodVisitor {
    ...
    private boolean shouldMutate() {
        final MutationIdentifier mutationId = this.context.registerMutation(new AODMutatorSecondOperand(),
