...
public class NullPointerFixingMutator implements  MethodMutatorFactory{
    @Override
    public MethodVisitor create(final MutationContext context,
                                final MethodInfo methodInfo,
                                final MethodVisitor methodVisitor) {
        return new NullPointerFixingVisitor(this, context,
                methodVisitor);
    }
    ...
    public String toString() {
        return "M1_NULL_POINTER_FIXING_MUTATOR";
    }
...
class NullPointerFixingVisitor extends MethodVisitor {

    final MutationContext context;
    final MethodMutatorFactory factory;

    public NullPointerFixingVisitor(
            final MethodMutatorFactory factory,
            final MutationContext context,
    ...
    private boolean shouldMutate(final String ownerName,
        ...
        final MutationIdentifier newId = this.context.registerMutation(
                this.factory, "M1: field dereference on object "
                        + ownerName
                        + " and field"
                        + fieldName
                        + " mutated with null check on object");
