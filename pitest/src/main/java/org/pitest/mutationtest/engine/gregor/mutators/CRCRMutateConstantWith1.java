...
public class CRCRMutateConstantWith1 implements MethodMutatorFactory {
  ...
  private final class NegateVariableVisitor extends MethodVisitor {
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCRMutateConstantWith1.this, "Bug fixed: CRCR replace with One, Substituted " + constant + " with "
              + replacement);
    ...
    private boolean shouldMutate() {
        final MutationIdentifier mutationId = this.context.registerMutation(new CRCRMutateConstantWith1(),
  ...
  public String toString() {
    return "CRCR_VARIABLE_MUTATOR_TO_ONE";
  }
