...
public class SecondOperandReplacesMutator implements MethodMutatorFactory {
  ...
  private final class NegateVariableVisitor extends MethodVisitor {
    ...
    private boolean shouldMutate() {
        final MutationIdentifier mutationId = this.context.registerMutation(new SecondOperandReplacesMutator(),
       "AOD: Replaced operate with second operand");
        return true;
        }
  ...
  public String toString() {
    return "AOD_MUTATOR_SECOND_OPERATOR";
  }
