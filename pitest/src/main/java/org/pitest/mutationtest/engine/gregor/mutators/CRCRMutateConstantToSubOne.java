...
public class CRCRMutateConstantToSubOne implements MethodMutatorFactory {
  ...
  private final class NegateVariableVisitor extends MethodVisitor {
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCRMutateConstantToSubOne.this, "Bug fixed: CRCR sub One, Substituted " + constant + " with "
              + replacement);
  ...
  public String toString() {
    return "CRCR_VARIABLE_MUTATOR_TO_SUB_ONE";
  }
