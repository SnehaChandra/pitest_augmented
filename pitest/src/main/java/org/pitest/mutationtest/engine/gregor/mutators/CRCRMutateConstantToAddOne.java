...
public class CRCRMutateConstantToAddOne implements MethodMutatorFactory {
  ...
  private final class NegateVariableVisitor extends MethodVisitor {
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCRMutateConstantToAddOne.this, "Bug fixed: CRCR Add One, Substituted " + constant + " with "
              + replacement);
  ...
  public String toString() {
    return "CRCR_VARIABLE_MUTATOR_TO_ADD_ONE";
  }
