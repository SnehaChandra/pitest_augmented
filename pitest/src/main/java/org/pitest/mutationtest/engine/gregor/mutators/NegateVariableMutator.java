...
public class NegateVariableMutator implements MethodMutatorFactory {
  ...
  private final class NegateVariableVisitor extends MethodVisitor {
    ...
    private void mutate(final Double constant) {
      ...
      final Double replacement = constant * -1;
    ...
    private void mutate(final Float constant) {
      ...
      final Float replacement = constant * -1;
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          NegateVariableMutator.this, "Bug fixed: Negate variable, Substituted " + constant + " with "
              + replacement);
  ...
  public String toString() {
    return "NEGATE_VARIABLE_MUTATOR";
  }
