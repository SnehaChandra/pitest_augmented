...
public class CRCRMutateConstantToSubOneTest extends MutatorTestBase {

	@Before
	public void setupEngineToMutateConstWithOne() {
		createTesteeWith(new CRCRMutateConstantToSubOne());
	}
	  ...
	  private static class HasInteger implements Callable<Integer> {
		  ...
		  public void shouldReplaceInteger() throws Exception {
		    ...
		    assertMutantCallableReturns(new HasInteger(), mutant, 9);
		  }
			...
			public void shouldCnangeLongAdd() throws Exception {
				...
				assertMutantCallableReturns(new MutantStarter<Long>(HasLADD.class), mutant, 10l);
			}
	...
	public void shouldNegateIntegerMemeberVariable() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Integer>(HasIntegerMemberVariable.class), mutant, 8);
	}
	...
	public void shouldNegateIntegerVariable() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Integer>(HasIntegerVariable.class), mutant, -3);
	}
