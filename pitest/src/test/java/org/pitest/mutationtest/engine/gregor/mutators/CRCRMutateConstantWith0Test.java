...
public class CRCRMutateConstantWith0Test extends MutatorTestBase {

	@Before
	public void setupEngineToMutateConstWithOne() {
		createTesteeWith(new CRCRMutateConstantWith0());
	}
	  ...
	  private static class HasInteger implements Callable<Integer> {
		  ...
		  public void shouldReplaceInteger() throws Exception {
		    ...
		    assertMutantCallableReturns(new HasInteger(), mutant, 0);
		  }
			...
			public void shouldCnangeLongAdd() throws Exception {
				...
				assertMutantCallableReturns(new MutantStarter<Long>(HasLADD.class), mutant, 0l);
			}
			...
			public void shouldCnangeLongMUL() throws Exception {
				...
				assertMutantCallableReturns(new MutantStarter<Long>(HasLMUL.class), mutant, 0l);
			}
			...
			public void shouldCnangeLongDIV() throws Exception {
				...
				assertMutantCallableReturns(new MutantStarter<Long>(HasLDIV.class), mutant, 0l);
			}
	...
	public void shouldNegateIntegerMemeberVariable() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Integer>(HasIntegerMemberVariable.class), mutant, 0);
	}
	...
	public void shouldNegateIntegerVariable() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Integer>(HasIntegerVariable.class), mutant, 0);
	}
	...
	public void shouldNegateDoubleMemberVariable() throws Exception {
		...
		assertMutantCallableReturns(new HasDoubleMemberVariable(), mutant, 0.0);
	}
	...
	public void shouldNegateLongMemberVariable() throws Exception {
		...
		assertMutantCallableReturns(new HasLongMemberVariable(), mutant, 0l);
	}
