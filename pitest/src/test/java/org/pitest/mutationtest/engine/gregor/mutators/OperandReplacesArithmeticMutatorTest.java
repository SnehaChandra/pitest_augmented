...
public class OperandReplacesArithmeticMutatorTest extends MutatorTestBase {

	@Before
	public void setupEngineToMutateOnlyNegs() {
		createTesteeWith(OperandReplacesArithmeticMutator.OPERAND_REPLACES_ARITHMETIC_MUTATOR);
	}
	...
	public void shouldCnangeIntegerAdd() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Integer>(HasIADD.class), mutant, 1);
	}
	...
	public void shouldCnangeDoubleAdd() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Double>(HasDADD.class), mutant, 1d);
	}
	...
	public void shouldCnangeFloatAdd() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Float>(HasFADD.class), mutant, 1f);
	}
	...
	public void shouldCnangeIntegerSub() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Integer>(HasISUB.class), mutant, 1);
	}
	...
	public void shouldCnangeLongDiv() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Long>(HasLDiv.class), mutant, 1l);
	}
	...
	public void shouldCnangeDoubleDiv() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Double>(HasDDiv.class), mutant, 1d);
	}
	...
	public void shouldCnangeIntegerMul() throws Exception {
		...
		assertMutantCallableReturns(new MutantStarter<Integer>(HasIMUL.class), mutant, 1);
	}
